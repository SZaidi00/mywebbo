...
const Aboutme = () => {
    return ( 
        ...
        <body>
            ...
            But if you want a more detailed answer, you'll have to interview me and I would happily explain it all :). The last thing I want to say about my schooling is that I did learn a lot while spending my time with these design teams and organizations.

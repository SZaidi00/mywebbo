...
const Aboutme = () => {
    return ( 
        ...
        <body>
            ...
            While it may not have been 100% "technical" in relation to Civil, Coastal Engineering, or Computer Science. I learnt a lot about working on a team, one where everyone gets a long and another where half the team is divided, what it really means to 
